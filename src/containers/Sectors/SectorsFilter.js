...
const SectorsFilter = ({ scopes, onGetSectors, t }) => {
              ...
              >
                <Formik initialValues={initialValues} onSubmit={handleFilter}>
                  <Form>
                    ...
                    <SelectInput label="Ámbito" name="scope" options={scopes.toJS()} />
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withTranslation('common')(SectorsFilter));
