...
const ExpertListItem = ({ data, handleClick, handleDelete, t }) => (
  <tr onClick={handleClick}>
    ...
    <td className="px-6 py-4 whitespace-nowrap">
      <div className="text-sm text-gray-600">
        {data.subSectorName && data.subSectorName.includes('{') ? (
          <div className={`${!JSON.parse(data.subSectorName)[i18n.language] && 'text-gray-400'}`}>
            {JSON.parse(data.subSectorName)[i18n.language] ||
...
export default withTranslation('common')(ExpertListItem);
